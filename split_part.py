...
carpeta_imagenes = '/home/ana/TFM/descargas resultados profesor/HiDrive/Tercer_experimento/sahi/images'
carpeta_labels = '/home/ana/JSON2YOLO/new_dir/labels'

# Crea las carpetas para los conjuntos de datos
sets = ['train', 'valid', 'test']
for set_name in sets:
    os.makedirs(f'/home/ana/TFM/datasets/dataset_derechos_privacidad/{set_name}/images', exist_ok=True)
    os.makedirs(f'/home/ana/TFM/datasets/dataset_derechos_privacidad/{set_name}/labels', exist_ok=True)
...
def move_files(files, set_name):
    for img, label in files:
        # Mover imágenes
        shutil.move(os.path.join(carpeta_imagenes, img), f'/home/ana/TFM/datasets/dataset_derechos_privacidad/{set_name}/images/{img}')
        # Mover etiquetas
        shutil.move(os.path.join(carpeta_labels, label), f'/home/ana/TFM/datasets/dataset_derechos_privacidad/{set_name}/labels/{label}')
